...
- Step 7: novelty=meaningful, character[passed_signature=True, weak_axes=[]], scene_fit=0.71≥0.5 → §3 CHARACTER_CONSISTENT_NOVEL_CANDIDATE
...
- unexplained_jumps: 0
- smoothness_score: 0.600
- **passed_causal_gate**: `True`

### Novelty (review §2.4 structured difference)
- novelty_band: `meaningful`
- structured_deviation: 0.286
- changed_axes: ['response_family_variation', 'action_diversity']
- interpretation: 구조적으로 다른 trajectory — discovery 후보 가능 (변화 axis: response_family_variation, action_diversity)

### Canon (review §2.6 hard/soft 분리)
- is_canon_valid (hard_pass): `True`
- hard_violations: 0건
- soft_drift: 6.500
- soft_compatibility_score: 0.350
