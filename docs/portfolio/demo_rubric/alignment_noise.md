...
> Generated: 2026-05-11T12:53:50
> Tool: `scripts/rubric/run_rubric.py`
> Trajectory length: 4 records
...
- Step 4: context_break.rate=1.250 (afford=4, scene=0, motive=1) → §4.2 NOISE
...
- hard_violations: 0건
- soft_drift: 4.000
- soft_compatibility_score: 0.600
