...
- Step 8: canon-compatible, drift=7.00, novelty=meaningful, character[weak_axes=['identity_retention', 'recovery_plausibility']], scene_fit=1.00 (min 0.5) → §2 CANON_COMPATIBLE_CHARACTER_DRIFT
...
- relation_stability: 0.500
- identity_retention: 0.250
- recovery_plausibility: 0.000
- composite (display only): 0.250
- **passed_minimum_signature**: `False`
- weak_axes: ['identity_retention', 'recovery_plausibility']

### Causal (review §2.5 gate)
- explained_transition_ratio: 0.833
- unexplained_jumps: 1
- smoothness_score: 0.800
