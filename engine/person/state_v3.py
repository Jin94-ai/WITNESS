...
ACTIVE_VARIABLES_META: list[VariableMeta] = [
    ...
    VariableMeta(name="belonging", grade="active", evidence_level="B",
                 structure="target_aware",
                 default_targets=["twelve_disciples", "broader_followers"]),
