...
def main() -> int:
    print("[Iter 146] Audit Iter 118 V3 strongest finding")
    ...
    if real_recovery >= 3:
        ...
        print("  Saturating agents (priest cohort) per Iter 138 are also real (real shame)")
    else:
        print(f"  Iter 118 finding QUESTIONABLE: only {real_recovery} agents had real recovery")
        print("  Cast augmentation may be partially no-shame artifact too")
